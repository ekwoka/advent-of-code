...
impl Vec2 {
  ...
  pub const NEIGHBORS: [Self;8] = {
    [Self::Y, Self::ONE, Self::X, Self::new(1,-1), Self::NEG_Y, Self::NEG_ONE, Self::NEG_X, Self::new(-1, 1)]
  };

  pub const NEIGHBORS_CARDINAL: [Self;4] = {
    [Self::Y, Self::X, Self::NEG_Y, Self::NEG_X]
  };
...
impl ToString for Vec2 {
  fn to_string(&self) -> String {
    format!("{},{}",self.x.to_string(),self.x.to_string())
  }
}
