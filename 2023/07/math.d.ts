...
export type Mult<LHS extends number, RHS extends number> = ToNumber<
  Join<MapToStrings<Product<ExplodeNumber<LHS>, ExplodeNumber<RHS>>>>
>;

type Product<
  LHS extends number[],
  RHS extends number[],
> = AllZeroes<RHS> extends true
  ? [0]
  : WrapAdd<LHS, Product<LHS, WrapDec<RHS>>>;
